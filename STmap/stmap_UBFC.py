...
if __name__ == "__main__":
    ...
    raw_vid_path = '/media/neuroai/T7/rPPG/rc_ContrastPhys/UBFC'  # Path to raw video directory
    output_stmap_path = '/media/neuroai/T7/rPPG/STMap_raw/UBFC'  # Path to output STmap directory
