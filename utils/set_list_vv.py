...
# path to raw data
path_to_data = '/media/neuroai/T7 Shield/Dataset/VitalVideos/vv100'
save_path = '/media/neuroai/94DC6878DC685690/rPPG/VV/VV100'
            ...
            with open(os.path.join(dirpath, filename)) as json_file:
                ...
                for scenario in data['scenarios']:
                    ...
                    if scenario['recordings']['RGB']['filename'] in filenames:
                        ...
                        np.save(save_path + save_filename[:-4] + ".npy", ppg_array)


# path to npy
npy_folder = '/media/neuroai/94DC6878DC685690/rPPG/VV/VV100/ts_bvps/*.npy'

# path to h5
output_hdf5_file = '/media/neuroai/94DC6878DC685690/rPPG/VV/VV100/VV100_ts_bvps.h5'
